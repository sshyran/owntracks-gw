...
public class InfoStato implements GlobCost {
    ...
    public synchronized String getDataSMS(int cod) {
        ...
        switch (cod) {
            case 1:
                return value1; // DATA dd-mm-aa			
            case 2:
                return value2; // ORA  hh:mm:ss			
            case 3:
                return value3; // LAT  dd pp' ss''.cc N/S			
            case 4:
                return value4; // LON  dd pp' ss''.cc E/W			
            case 5:
                return value5; // ROT			
            case 6:
                return value6; // ALT
            case 7:
                return value7; // VEL kmh
            default:
                return "ERROR";
        }
    }
     ...
     * @param virg	indicates quotation marks presence in the extracted field,
     * 'false' = there shouldn't be quotation marks
     *
