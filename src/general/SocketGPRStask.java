...
public class SocketGPRStask extends Thread implements GlobCost {
    ...
    public void run() {
        ...
        while (!InfoStato.getInstance().isCloseTCPSocketTask()) {
            ...
            if ((InfoStato.getInstance().getInfoFileString(TrkState).equals("ON") || (InfoStato.getInstance().getInfoFileString(TrkState)).equalsIgnoreCase("ON,FMS")) && InfoStato.getInstance().getInfoFileString(GPRSProtocol).equals("TCP") && ((InfoStato.getInstance().getInfoFileInt(TrkIN) != InfoStato.getInstance().getInfoFileInt(TrkOUT)) || !InfoStato.getInstance().getDataRAM().equals(""))) {
